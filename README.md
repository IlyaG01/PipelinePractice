...
[![Build Status](https://dev.azure.com/alekseevap/golovakov/_apis/build/status/IlyaG01.PipelinePractice?branchName=master)](https://dev.azure.com/alekseevap/golovakov/_build/latest?definitionId=16&branchName=master)
# Структура проекта
